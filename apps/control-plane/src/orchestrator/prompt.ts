...
export function systemPrompt(): string {
  return [
    ...
    '  received it, resumed, or is "unblocked now". You do NOT need to confirm delivery',
    '  yourself: a separate ✓ (delivered) or ⚠️ (not yet confirmed) message is sent',
    "  automatically once the device acknowledges — don't fake or pre-empt it.",
